...
required_packages <- c(
  "ggplot2", "tibble", "ggdist", "tidyr", "gghalves", "patchwork",
  "dplyr", "tidyverse", "data.table", "ggthemes", "plotly", "caret",
  "randomForest", "xgboost", "class", "cluster", "stats", "BayesianTools",
  "gridExtra", "viridis", "RColorBrewer", "psych", "grid", "GGally", "purrr", 
  "ggprism", "scales", "reshape2", "pheatmap", "rgl", "devtools", "ggforce"
)
